...
wget https://raw.githubusercontent.com/dpater1986/Pater-s-OpenSuse-setup/main/bachrc.aliases
...
sudo zypper ar https://download.opensuse.org/tumbleweed/repo/oss openSUSE:Factory
## 3.3 Microsoft teams
